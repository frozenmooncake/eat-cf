...
export const menuData = {
  canteens: [
    ...
    { id: 'canting2', label: '二餐厅', floors: [
        { floor: 1, label: '一楼', windows: [
          { num: 1, name: '麻辣烫江湖', items: [{ dish: '麻辣烫（荤素同价）', price: '1.58元/两' }] },
          { num: 2, name: '鸡汤米线', items: [{ dish: '麻酱米线', price: '8元' }, { dish: '热干面', price: '7元' }, { dish: '肉酱米线', price: '10元' }, { dish: '油泼面', price: '10元' }, { dish: '鸡丁米线', price: '12元' }, { dish: '老北京炸酱面', price: '10元' }] },
          { num: 3, name: '兰州牛肉面', items: [{ dish: '牛肉拉面', price: '8元' }, { dish: '酸菜牛肉面', price: '10元' }, { dish: '西红柿鸡蛋面', price: '10元' }, { dish: '牛肉水饺', price: '12元' }, { dish: '牛肉哨子面', price: '12元' }, { dish: '大盘鸡拌面', price: '13元' }, { dish: '小盘牛肉', price: '10元' }, { dish: '大盘牛肉', price: '40元' }, { dish: '鸡蛋', price: '1.5元' }, { dish: '豆腐干', price: '1.5元' }, { dish: '豆皮', price: '2元' }, { dish: '糖蒜', price: '2元' }, { dish: '狮子头丸子', price: '2元' }, { dish: '玉米', price: '3元' }] },
          { num: 4, name: '米饭套餐', items: [{ dish: '一荤两素', price: '10元' }, { dish: '两荤一素', price: '13元' }, { dish: '两荤两素', price: '15元' }] },
          { num: 5, name: '精品早餐', items: [{ dish: '葱油饼', price: '8元/斤' }, { dish: '鲜肉包子', price: '2元' }, { dish: '牛肉胡辣汤', price: '5元' }, { dish: '油馍头', price: '8元/斤' }, { dish: '茶叶蛋', price: '1.5元' }, { dish: '黑米粥', price: '2元' }, { dish: '八宝粥', price: '3元' }, { dish: '小米粥', price: '2元' }, { dish: '豆浆', price: '2元' }] },
          { num: 6, name: '私房小厨', items: [{ dish: '炒鸡拌饭', price: '13元' }, { dish: '口水鸡拌饭', price: '13元' }, { dish: '特色炒饭', price: '9元' }, { dish: '特色炒面', price: '9元' }, { dish: '炒广东米粉', price: '9元' }, { dish: '肉夹馍', price: '6元' }, { dish: '大鸡腿', price: '7元' }, { dish: '鸡翅', price: '5元' }, { dish: '鸡脖', price: '3元' }, { dish: '面筋', price: '5元' }] },
          { num: 7, name: '小郑家一口鲜馄饨', items: [{ dish: '经典鲜肉馄饨', price: '10元' }, { dish: '招牌皮蛋馄饨', price: '10元' }, { dish: '玉米鲜肉馄饨', price: '10元' }, { dish: '虾仁鲜肉馄饨', price: '15元' }, { dish: '猪肉水饺', price: '12元' }, { dish: '煎鸡蛋', price: '1.5元' }, { dish: '烤肉肠', price: '3元' }] },
        ] },
      ] },
  ],
  snackStreet: {
    ...
    entries: [
      ...
      },
      {
        ...
        items: [
          ...
          { dish: '2张烤冷面+鸡蛋+鸡柳', price: '7元' },
          { dish: '火鸡面+烤冷面', price: '10元' },
          { dish: '标配烤冷面+鸡蛋+香肠', price: '5元' },
          { dish: '芝士火鸡面+烤冷面', price: '14元' },
          { dish: '烤冷面+鸡蛋+香肠+鸡柳', price: '6元' },
          { dish: '2张烤冷面+2个鸡蛋+培根', price: '8元' },
          { dish: '三养火鸡面+烤冷面', price: '14元' },
          { dish: '三养火鸡面+芝士+烤冷面', price: '18元' },
          { dish: '2份标配烤冷面合装（送一串）', price: '10元' },
        ],
        note: '口味：酸甜辣',
      },
      {
      ...
      },
      {
        ...
        range: '8-20元',
        items: [
          { dish: '鸡柳烧饼', price: '小份8元/中份10元/大份15元/超大份20元' },
          { dish: '炸鸡柳', price: '小份10元/中份15元/大份20元' },
          { dish: '烧鸡柳饼', price: '待确认' },
        ],
      },
      {
      ...
      },
      {
        name: '陈记 无籽冰糖葫芦',
        items: [
          { dish: '无籽冰糖葫芦', price: '待确认' },
          { dish: '烤冷面', price: '待确认' },
          { dish: '芝士火鸡面', price: '待确认' },
        ],
      },
      {
        name: '大饼鸡蛋·铁板炒饭',
      ...
      },
      {
        name: '经典臭豆腐·馍夹万物',
        items: [
          { dish: '小份臭豆腐', price: '8元(8片)' },
          { dish: '大份臭豆腐', price: '10元(10片)' },
          { dish: '超大份臭豆腐', price: '15元(16片)' },
        ],
      },
      {
        name: '烤炉鸡蛋灌饼',
      ...
      },
      {
        ...
        range: '5-58元',
        items: [
          { dish: '大生蚝', price: '48元/打(12个)，20元/5个' },
          { dish: '中生蚝', price: '30元/打(12个)，20元/8个' },
          { dish: '蒜蓉粉丝虾滑', price: '20元/18个' },
          { dish: '蒜蓉铁板大虾', price: '38元/份' },
          { dish: '水煮花生', price: '10元/份' },
          { dish: '郎酒', price: '大瓶58元/小瓶15元' },
          { dish: '老雪啤酒', price: '5元' },
          { dish: '百威啤酒', price: '8元' },
        ],
      },
      ...
      },
      {
        ...
        range: '1-3元',
        items: [
          { dish: '串串', price: '1元/串、2元/串、3元/串' },
        ],
      },
      {
        name: '梅干菜潼关肉夹馍·关东煮（酱香饼）',
        range: '5-8元',
        items: [
          { dish: '梅干菜肥瘦肉夹馍', price: '7元' },
          { dish: '梅干菜纯瘦肉夹馍', price: '8元' },
          { dish: '豆皮+海带+鸡蛋', price: '5元' },
          { dish: '酱香饼', price: '待确认' },
        ],
      },
      {
        ...
        range: '3-5元',
        items: [
          { dish: '冰糖葫芦（1串）', price: '3元1串' },
          { dish: '冰糖葫芦（2串）', price: '5元2串' },
        ],
      },
      {
        name: '南昌拌粉（米线/面）',
        items: [
          { dish: '肉酱拌面/粉', price: '待确认' },
          { dish: '南昌拌粉', price: '待确认' },
          { dish: '招牌米线/面', price: '待确认' },
          { dish: '肉沫酸辣粉/面', price: '待确认' },
        ],
      },
      {
        name: '陕西味道（新家园牛肉面馆）',
      ...
      },
      {
        ...
        range: '8-10元',
        items: [
          { dish: '辣子鸡焖面', price: '8元/10元' },
          { dish: '豆角焖面', price: '8元/10元' },
          { dish: '铁锅焖面', price: '8元/10元' },
        ],
      },
      {
        name: '土家酱香饼',
      ...
      },
      {
        name: '张记（正宗长沙臭豆腐）',
        items: [
          { dish: '长沙臭豆腐', price: '待确认' },
        ],
      },
      {
        name: '串串香麻辣烫',
        items: [
          { dish: '串串香麻辣烫', price: '待确认' },
        ],
      },
      {
        name: '川人川味',
        ...
        items: [
          { dish: '回锅肉炒饭', price: '8元' },
          { dish: '蛋炒饭', price: '6元' },
          { dish: '回锅肉炒饼丝', price: '8元' },
          { dish: '泡椒鸡炒饭', price: '10元' },
          { dish: '肉片炒河粉', price: '8元' },
          { dish: '香菇肉片炒饭', price: '8元' },
          { dish: '青椒肉片炒饭', price: '8元' },
          { dish: '泡椒牛肉炒饭', price: '12元' },
          { dish: '姜爆鸭丝炒饭', price: '12元' },
          { dish: '肉片炒面', price: '8元' },
          { dish: '辣子鸡+米饭', price: '20元/份' },
          { dish: '青椒肉片+米饭', price: '13元/份' },
          { dish: '泡椒牛肉+米饭', price: '20元/份' },
          { dish: '香菇肉片+米饭', price: '13元/份' },
          { dish: '水煮肉片+米饭', price: '15元/份' },
          { dish: '木耳肉片+米饭', price: '13元/份' },
          { dish: '麻婆豆腐+米饭', price: '15元/份' },
          { dish: '西葫芦炒肉+米饭', price: '13元/份' },
          { dish: '泡椒鸡+米饭', price: '15元/份' },
          { dish: '豆干炒肉+米饭', price: '13元/份' },
          { dish: '生爆盐煎肉+米饭', price: '15元/份' },
          { dish: '豆角炒肉+米饭', price: '13元/份' },
          { dish: '姜爆鸭丝+米饭', price: '15元/份' },
          { dish: '爆炒猪肝+米饭', price: '10元/份' },
          { dish: '干烧鱼+米饭', price: '15元/份' },
          { dish: '青椒炒鸡蛋+米饭', price: '10元/份' },
          { dish: '鱼香肉丝+米饭', price: '13元/份' },
          { dish: '娃娃菜炒鸡蛋+米饭', price: '10元/份' },
          { dish: '回锅肉+米饭', price: '13元/份' },
          { dish: '西红柿炒鸡蛋+米饭', price: '10元/份' },
          { dish: '蛋炒饭+老干妈+火腿肠', price: '6元/份' },
          { dish: '盐煎肉炒饭+鸡蛋', price: '8元/份' },
          { dish: '回锅肉炒饭+鸡蛋', price: '8元/份' },
          { dish: '泡椒鸡胗炒饭+鸡蛋', price: '10元/份' },
          { dish: '青椒肉片炒饭+鸡蛋', price: '8元/份' },
          { dish: '姜爆鸭丝炒饭+鸡蛋', price: '12元/份' },
          { dish: '木耳肉片炒饭+鸡蛋', price: '8元/份' },
          { dish: '泡椒牛肉炒饭+鸡蛋', price: '12元/份' },
          { dish: '香菇肉片炒饭+鸡蛋', price: '8元/份' },
          { dish: '辣子鸡炒饭+鸡蛋', price: '15元/份' },
        ],
      },
      {
        name: '来杯冰沙（饮品）',
        items: [
          { dish: '招牌手工红糖冰粉', price: '待确认' },
          { dish: '原味奶茶', price: '待确认' },
          { dish: '柠檬水', price: '待确认' },
          { dish: '绿豆沙牛乳', price: '待确认' },
          { dish: '草莓大果粒奶茶', price: '待确认' },
          { dish: '芒果大果粒奶茶', price: '待确认' },
          { dish: '香蕉大果粒奶茶', price: '待确认' },
          { dish: '茉莉绿茶', price: '待确认' },
          { dish: '柠檬红茶', price: '待确认' },
          { dish: '白桃乌龙柠檬茶', price: '待确认' },
          { dish: '鸭屎香柠檬茶', price: '待确认' },
          { dish: '百香果爆柠茶', price: '待确认' },
          { dish: '西瓜爆柠茶', price: '待确认' },
          { dish: '香橙爆柠茶', price: '待确认' },
          { dish: '话梅爆柠茶', price: '待确认' },
          { dish: '羽衣甘蓝柠檬茶', price: '待确认' },
          { dish: '白桃紫苏柠檬茶', price: '待确认' },
          { dish: '蜜桃茉莉柠檬茶', price: '待确认' },
          { dish: '抹茶牛乳', price: '待确认' },
          { dish: '抹茶耶耶', price: '待确认' },
          { dish: '牛油果冰奶', price: '待确认' },
          { dish: '粉桃冰奶', price: '待确认' },
          { dish: '蓝柑冰奶', price: '待确认' },
          { dish: '荔枝冰奶', price: '待确认' },
          { dish: '柠檬养乐多', price: '待确认' },
          { dish: '草莓养乐多', price: '待确认' },
          { dish: '芒果养乐多', price: '待确认' },
          { dish: '白桃紫苏养乐多', price: '待确认' },
          { dish: '手工双皮奶', price: '待确认' },
          { dish: '杨枝甘露冰沙', price: '待确认' },
          { dish: '现煮冰汤圆', price: '待确认' },
          { dish: '冰/热美式', price: '待确认' },
          { dish: '生椰拿铁', price: '待确认' },
          { dish: '牛油果拿铁', price: '待确认' },
          { dish: '酸梅汤', price: '待确认' },
        ],
      },
    ],
